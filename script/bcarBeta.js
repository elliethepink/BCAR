...
(async function () {
        ...
        modApi.hookFunction("ChatRoomClick", 4, (args, next) => {
            if (Player.BCAR.bcarSettings.earWigglingEnable) {
                if (Player.BCAR.bcarSettings.animationButtonsEnable) {
                    if (
                        Player.BCAR.bcarSettings.animationButtonsPosition ===
                        "upperleft"
                    ) {
                        if (
                            MouseX >= 0 &&
    ...
    const TriggerAdditions = [
        ...
        },
        {
            ...
            Matchers: [
                {
                    Tester: /^((is|seems|looks) (confused|curious|suspicious)|raises an eyebrow)/u,
                },
            ],
        },
        {
    ...
    const typeAction = {
        cat: {
            EarCaress: [
                {
                    sound: "",
                    action: "%NAME% closes %POSSESSIVE% eyes and purrs as %OPP_NAME% pets %POSSESSIVE% ear.",
                },
                {
                    sound: "",
                    action: "%NAME% twitches %POSSESSIVE% ears, enjoying the sensation.",
                },
                {
                    sound: "",
                    action: "%NAME% leans into %OPP_NAME%'s touch, savoring the ear scratch.",
                },
                {
                    sound: "",
                    action: "%NAME%'s ear flicks with delight at %OPP_NAME%'s caresses.",
                },
                {
                    sound: "",
                    action: "%NAME% nuzzles into %OPP_NAME%'s hand, savoring the ear rub.",
                },
                {
                    sound: "",
                    action: "%NAME% lets out a contented sigh as %OPP_NAME% pets %POSSESSIVE% ear.",
                },
                {
                    sound: "",
                    action: "%NAME% leans into %OPP_NAME%'s hand, enjoying the ear scratch.",
                },
                {
                    sound: "",
                    action: "%NAME% makes soft noises of enjoyment as %OPP_NAME% rubs %POSSESSIVE% ear.",
                },
                {
                    sound: "",
                    action: "%NAME% visibly relaxes under %OPP_NAME%'s touch on %POSSESSIVE% ear.",
                },
                {
                    sound: "",
                    action: "%NAME% nuzzles into %OPP_NAME%'s hand, relishing the gentle touch on %POSSESSIVE% ear.",
                },
                {
                    sound: "",
                    action: "%OPP_NAME%'s soothing touch causes %NAME% to relax and wiggle %POSSESSIVE% ear in contentment.",
                },
                {
                    sound: "",
                    action: "%NAME% presses %POSSESSIVE% ear into %OPP_NAME%'s hand, soaking in the affection.",
                },
            ],
            EarNibble: [
                {
                    sound: "",
                    action: "%OPP_NAME%'s soft nibbles send shivers down %NAME%'s spine, making %POSSESSIVE% ear twitch.",
                },
                {
                    sound: "",
                    action: "%NAME%'s ear twitches with pleasure as %OPP_NAME% nibbles it.",
                },
                {
                    sound: "",
                    action: "%NAME% leans into %OPP_NAME%'s touch, savoring the ear nibble.",
                },
                {
                    sound: "",
                    action: "%NAME%'s ear twitches with joy as %OPP_NAME% nibbles %POSSESSIVE% ear.",
                },
                {
                    sound: "",
                    action: "%NAME% nuzzles closer to %OPP_NAME%, enjoying the ear nibble.",
                },
                {
                    sound: "",
                    action: "%NAME% lets out a contented purr as %OPP_NAME% nibbles %POSSESSIVE% ear.",
                },
                {
                    sound: "",
                    action: "With a flick of %POSSESSIVE% ear, %NAME% expresses %POSSESSIVE% enjoyment of %OPP_NAME%'s attention.",
                },
                {
                    sound: "",
                    action: "%NAME% closes %POSSESSIVE% eyes, purring as %OPP_NAME% teases %POSSESSIVE% ear.",
                },
            ],
            EarLick: [
                {
                    sound: "",
                    action: "A soft meow escapes %NAME% as %OPP_NAME% licks %POSSESSIVE% ear",
                },
                {
                    sound: "",
                    action: "%NAME% twitches %POSSESSIVE% ear with pleasure as %OPP_NAME% licks it.",
                },
                {
                    sound: "",
                    action: "%NAME% nuzzles closer to %OPP_NAME%, savoring the ear lick.",
                },
                {
                    sound: "",
                    action: "%NAME%'s ear twitches with delight as %OPP_NAME% licks %POSSESSIVE% ear.",
                },
                {
                    sound: "",
                    action: "%NAME%'s ear flickers with enjoyment as %OPP_NAME% licks it.",
                },
                {
                    sound: "",
                    action: "%NAME% closes %POSSESSIVE% eyes, contentedly purring as %OPP_NAME% licks %POSSESSIVE% ear.",
                },
                {
                    sound: "",
                    action: "%NAME% leans into the attention, %POSSESSIVE% ears are twitching as %OPP_NAME% licks it.",
                },
            ],
            EarKiss: [
                {
                    sound: "",
                    action: "%NAME% nuzzles %OPP_NAME%'s cheek, seeming to enjoy the ear kiss.",
                },
                {
                    sound: "",
                    action: "%NAME%'s ears twitch in delight as %OPP_NAME% kisses %POSSESSIVE% ear.",
                },
                {
                    sound: "",
                    action: "%NAME% closes %POSSESSIVE% eyes, relishing in the affection from %OPP_NAME%'s ear kiss.",
                },
                {
                    sound: "",
                    action: "%NAME% meows contentedly, clearly enjoying the ear kiss from %OPP_NAME%.",
                },
                {
                    sound: "",
                    action: "%NAME% leans into the ear kiss from %OPP_NAME%, basking in the love and attention.",
                },
                {
                    sound: "",
                    action: "%NAME% lets out a soft purr as %OPP_NAME% gives %POSSESSIVE% a kiss on the ear.",
                },
                {
                    sound: "",
                    action: "%OPP_NAME%'s kiss on the ear brings a happy grin to %NAME%'s face.",
                },
                {
                    sound: "",
                    action: "%NAME% can't help but purr as %OPP_NAME% plants a kiss on %POSSESSIVE% ear.",
                },
                {
                    sound: "",
                    action: "%NAME% leans into %OPP_NAME%'s affection, a contented grin on %POSSESSIVE% face.",
                },
                {
                    sound: "",
                    action: "%OPP_NAME%'s kiss makes %NAME% feel safe, %POSSESSIVE% ears folding backwards in trust.",
                },
            ],
            HeadBrush: [
                {
                    sound: "",
                    action: "%NAME% closes %POSSESSIVE% eyes, thoroughly enjoying the brush from %OPP_NAME%.",
                },
                {
                    sound: "",
                    action: "%NAME% closes %POSSESSIVE% eyes, enjoying the feeling of %OPP_NAME% brushing %POSSESSIVE% hair.",
                },
                {
                    sound: "",
                    action: "%NAME% relaxes into %OPP_NAME%'s touch as %OPP_NAME% brushes %POSSESSIVE% hair.",
                },
                {
                    sound: "",
                    action: "%NAME% purrs contently as %OPP_NAME% strokes %POSSESSIVE% hair.",
                },
                {
                    sound: "",
                    action: "%NAME%'s ears perk up as %OPP_NAME% brushes %POSSESSIVE% hair.",
                },
                {
                    sound: "",
                    action: "%NAME% twitches %POSSESSIVE% ears in delight as %OPP_NAME% smooths out tangles in %POSSESSIVE% hair.",
                },
                {
                    sound: "",
                    action: "%NAME%'s body sways with the rhythm of %OPP_NAME%'s brush strokes.",
                },
                {
                    sound: "",
                    action: "%NAME%'s body relaxes as %OPP_NAME% brushes away all of %POSSESSIVE% worries.",
                },
                {
                    sound: "",
                    action: "%NAME% hums with contentment while %OPP_NAME% brushes %POSSESSIVE% hair.",
                },
                {
                    sound: "",
                    action: "%NAME% nuzzles %OPP_NAME% affectionately as %POSSESSIVE% hair is brushed.",
                },
            ],
            HeadPat: [
                {
                    sound: "",
                    action: "%NAME% is purring contently as %OPP_NAME% gently pets %POSSESSIVE% head.",
                },
                {
                    sound: "",
                    action: "%NAME% is closing %POSSESSIVE% eyes and nuzzling into %OPP_NAME%'s hand as %OPP_NAME% pets %POSSESSIVE% head.",
                },
                {
                    sound: "",
                    action: "%NAME%'s ears are twitching with pleasure as %OPP_NAME% pets %POSSESSIVE% head.",
                },
                {
                    sound: "",
                    action: "%NAME% leans into %OPP_NAME%'s hand, enjoying the gentle petting on %POSSESSIVE% head.",
                },
                {
                    sound: "",
                    action: "%NAME% is relaxing completely as %OPP_NAME% runs %POSSESSIVE% hand over %POSSESSIVE% head.",
                },
                {
                    sound: "",
                    action: "With eyes closed, %NAME% purrs as %OPP_NAME% pets %POSSESSIVE% head, %POSSESSIVE% ears twitching with each stroke.",
                },
                {
                    sound: "",
                    action: "%NAME%'s ears flop adorably as %OPP_NAME% pets %INTENSIVE%.",
                },
            ],
            CaressBack: [
                {
                    sound: "",
                    action: "%NAME%'s tail twitches happily as %OPP_NAME% strokes %POSSESSIVE% fur.",
                },
                {
                    sound: "",
                    action: "%NAME% closes %POSSESSIVE% eyes in contentment, enjoying the sensation of %OPP_NAME%'s gentle touch.",
                },
                {
                    sound: "",
                    action: "%NAME% is purring with delight as %OPP_NAME% runs a hand down %POSSESSIVE% back.",
                },
                {
                    sound: "",
                    action: "%NAME%'s tail curves into a satisfied arch as %OPP_NAME% pets %POSSESSIVE% back.",
                },
                {
                    sound: "",
                    action: "%NAME% rumbles contentedly as %OPP_NAME% strokes %POSSESSIVE% back, tail twitching in pleasure.",
                },
                {
                    sound: "",
                    action: "%NAME%'s tail curls around %OPP_NAME%'s hand, a sign of enjoyment as %NAME% relaxes.",
                },
            ],
            MassageBack: [
                {
                    sound: "",
                    action: "%NAME%'s tail sways as %OPP_NAME% pampers %POSSESSIVE% with a back massage.",
                },
                {
                    sound: "",
                    action: "%NAME% closes %POSSESSIVE% eyes and purrs as %OPP_NAME% gently rubs %POSSESSIVE% back.",
                },
                {
                    sound: "",
                    action: "%NAME%'s tail twitches with pleasure as %OPP_NAME% massages %POSSESSIVE% back.",
                },
                {
                    sound: "",
                    action: "%NAME% stretches and relaxes under %OPP_NAME%'s skilled touch.",
                },
                {
                    sound: "",
                    action: "%NAME%'s purrs become louder as %OPP_NAME% massages %POSSESSIVE% back.",
                },
                {
                    sound: "",
                    action: "%NAME%'s tail twitches back and forth with delight as %OPP_NAME% massages %POSSESSIVE% back.",
                },
            ],
            CaressButt: [
                {
                    sound: "",
                    action: "%NAME%'s tail twirls with happiness as %OPP_NAME% caresses %POSSESSIVE% butt.",
                },
                {
                    sound: "",
                    action: "%NAME%'s purrs become louder as %OPP_NAME% massages %POSSESSIVE% butt.",
                },
                {
                    sound: "",
                    action: "%NAME% purrs and the tips of %POSSESSIVE% tail twitches in pleasure as %OPP_NAME% strokes %POSSESSIVE% butt.",
                },
                {
                    sound: "",
                    action: "%NAME%'s tail twirls and %POSSESSIVE% eyes soften as %OPP_NAME% rubs %POSSESSIVE% butt.",
                },
                {
                    sound: "",
                    action: "%NAME%'s tail wags eagerly as %OPP_NAME% runs some fingers along %POSSESSIVE% butt.",
                },
                {
                    sound: "",
                    action: "%OPP_NAME%'s soft touch makes %NAME% purr with joy and wag %POSSESSIVE% tail.",
                },
                {
                    sound: "",
                    action: "A deep purr rumbles from %NAME% as %OPP_NAME% strokes %POSSESSIVE% butt.",
                },
            ],
        },
        dog: {
            EarCaress: [
                {
                    sound: "",
                    action: "%NAME%'s eyes close as %OPP_NAME% rubs %POSSESSIVE% ear gently.",
                },
                {
                    sound: "",
                    action: "%NAME% leans into %OPP_NAME%'s hand, enjoying the ear scratch.",
                ...
                {
                    sound: "",
                    action: "%NAME%'s ear perks up as %OPP_NAME% strokes it softly.",
                },
                {
                    sound: "",
                    action: "%NAME% sighs contentedly as %OPP_NAME% massages %POSSESSIVE% ear.",
                },
                {
                    sound: "",
                    action: "%NAME%'s ear flops happily under %OPP_NAME%'s touch.",
                },
                {
                    sound: "",
                    action: "%NAME%'s ear vibrates with pleasure as %OPP_NAME% rubs it.",
                },
                {
                    sound: "",
                    action: "%NAME% lets out a soft growl, enjoying %OPP_NAME%'s ear rub.",
                },
            ],
            EarNibble: [
                {
                    sound: "",
                    action: "%NAME%'s ear quivers with delight as %OPP_NAME% nibbles it.",
                },
                {
                    sound: "",
                    action: "%NAME% lets out a happy sigh as %OPP_NAME% gently nips %POSSESSIVE% ear.",
                },
                {
                    sound: "",
                    action: "%NAME%'s ear perks up, eager for more from %OPP_NAME%'s nibbling.",
                },
                {
                    sound: "",
                    action: "%NAME%'s ear twitches as %OPP_NAME% gently nibbles it.",
                },
                {
                    sound: "",
                    action: "%NAME%'s body relaxes as %OPP_NAME% continues to nibble %POSSESSIVE% ear.",
                },
                {
                    sound: "",
                    action: "%NAME% lets out a contented sigh as %OPP_NAME% nibbles %POSSESSIVE% ear.",
                },
            ],
            EarLick: [
                {
                    sound: "",
                    action: "%NAME% grins, reveling in the attention from %OPP_NAME% licking %POSSESSIVE% ear.",
                },
                {
                    sound: "",
                    action: "%NAME%'s ear wiggles, %POSSESSIVE% tail thumping, as %OPP_NAME% licks.",
                },
                {
                    sound: "",
                    action: "%NAME% eagerly leans into %OPP_NAME%'s ear licking, enjoying the sensation.",
                },
                {
                    sound: "",
                    action: "%NAME% closes %POSSESSIVE% eyes and relaxes as %OPP_NAME% licks %POSSESSIVE% ear.",
                },
                {
                    sound: "",
                    action: "%NAME%'s whole body shivers with happiness as %OPP_NAME% licks %POSSESSIVE% ear.",
                },
                {
                    sound: "",
                    action: "%NAME%'s ear twitches with delight as %OPP_NAME% licks it.",
                },
            ],
            EarKiss: [
                {
                ...
                {
                    sound: "",
                    action: "%NAME% lets out a content sigh as %OPP_NAME% kisses %POSSESSIVE% ear.",
                },
                {
                    sound: "",
                    action: "%NAME%'s ear twitches in delight as %OPP_NAME% gives it a kiss.",
                },
                {
                    sound: "",
                    action: "%NAME% closes %POSSESSIVE% eyes and relaxes as %OPP_NAME% kisses %POSSESSIVE% ear.",
                },
                {
                    sound: "",
                    action: "%NAME%'s ear flops affectionately as %OPP_NAME% plants a kiss.",
                },
                {
                    sound: "",
                    action: "%NAME% gives a contented sigh as %OPP_NAME% kisses %POSSESSIVE% ear.",
                },
            ],
            HeadBrush: [
                {
                    sound: "",
                    action: "%NAME%'s muscles relax as %OPP_NAME% expertly brushes %POSSESSIVE% hair.",
                },
                {
                    sound: "",
                    action: "%NAME%'s breathing slows down, relishing the brush from %OPP_NAME%.",
                },
                {
                    sound: "",
                    action: "%NAME%'s eyes sparkle as %OPP_NAME% brushes away any tangles in %POSSESSIVE% hair.",
                },
                {
                    sound: "",
                    action: "%NAME%'s body sways with the rhythm of %OPP_NAME%'s brush strokes.",
                ...
                {
                    sound: "",
                    action: "%NAME% nuzzles against %OPP_NAME% while %OPP_NAME% brushes %POSSESSIVE% hair.",
                },
                {
                    sound: "",
                    action: "%NAME%'s body relaxes as %OPP_NAME% brushes away all of %POSSESSIVE% worries.",
            ...
            HeadPat: [
                {
                    sound: "",
                    action: "%NAME% closes %POSSESSIVE% eyes in bliss as %OPP_NAME% strokes %POSSESSIVE% head.",
                },
                {
                    sound: "",
                    action: "%NAME% leans into the petting, %POSSESSIVE% ears flicking contentedly.",
                },
                {
                    sound: "",
                    action: "A soft sigh escapes %NAME% as %OPP_NAME% gently pets %POSSESSIVE% head.",
                },
                {
                    sound: "",
                    action: "%NAME% nuzzles into %OPP_NAME%'s hand, %POSSESSIVE% ears twitching with pleasure.",
                },
                {
                    sound: "",
                    action: "%NAME% gives a content sigh, settling into the comfort of %OPP_NAME%'s touch.",
                },
                {
                    sound: "",
                    action: "%NAME% leans into the petting, making %POSSESSIVE% body completely relaxed.",
                },
            ],
            CaressBack: [
                {
                    sound: "",
                    action: "%NAME%'s tail wags as %OPP_NAME% strokes %POSSESSIVE% back.",
                },
                {
                    sound: "",
                    action: "%NAME% leans into %OPP_NAME%'s touch, tail wagging happily.",
                },
                {
                    sound: "",
                    action: "%NAME%'s tail wags happily as %OPP_NAME% scratches %POSSESSIVE% back.",
                },
                {
                    sound: "",
                    action: "%NAME%'s eyes close in contentment as %OPP_NAME% rubs %POSSESSIVE% back.",
                },
                {
                    sound: "",
                    action: "%NAME%'s eyes close in bliss as %OPP_NAME% pampers %POSSESSIVE% back.",
                },
                {
                    sound: "",
                    action: "%NAME%'s tail wags back and forth as %OPP_NAME% rubs %POSSESSIVE% back.",
                },
            ],
            MassageBack: [
                {
                    sound: "",
                    action: "%NAME%'s tail wags contentedly as %OPP_NAME% massages %POSSESSIVE% back.",
                },
                {
                    sound: "",
                    action: "%NAME% closes %POSSESSIVE% eyes, enjoying the sensation of the massage.",
                },
                {
                    sound: "",
                    action: "%NAME% leans into %OPP_NAME%'s touch, tail swaying back and forth.",
                },
                {
                    sound: "",
                    action: "%NAME% lets out a soft sigh, tail lazily wagging as %OPP_NAME% massages.",
                },
                {
                    sound: "",
                    action: "%NAME% is savoring every moment, wagging %POSSESSIVE% tail joyfully.",
                },
                {
                    sound: "",
                    action: "%NAME% is completely relaxed and wags %POSSESSIVE% tail contentedly.",
                },
            ],
            CaressButt: [
                {
                    sound: "",
                    action: "%OPP_NAME%'s touch sends shivers down %NAME%'s back, causing %POSSESSIVE% tail to quiver.",
                },
                {
                    sound: "",
                    action: "%NAME%'s tail twitches with pleasure as %OPP_NAME% rubs %POSSESSIVE% butt.",
                },
                {
                    sound: "",
                    action: "%NAME% is in pure heaven, tail wagging at full speed.",
                },
                {
                    sound: "",
                    action: "%NAME%'s tail wags eagerly as %OPP_NAME% runs some fingers along %POSSESSIVE% butt.",
                ...
                {
                    sound: "",
                    action: "Ears perked up, %NAME% revels in the attention on %POSSESSIVE% butt.",
                },
                {
                    sound: "",
                    action: "%NAME%'s tail curls happily as %OPP_NAME% pets %POSSESSIVE% butt.",
                },
            ],
        },
        fox: {
            EarCaress: [
                {
                    sound: "",
                    action: "%NAME% closes %POSSESSIVE% eyes and leans into %OPP_NAME%'s touch.",
                },
                {
                    sound: "",
                    action: "%NAME% emits a contented sigh as %OPP_NAME% rubs %POSSESSIVE% ear.",
                },
                {
                    sound: "",
                    action: "%NAME% tilts %POSSESSIVE% head to enjoy %OPP_NAME%'s touch more.",
                },
                {
                    sound: "",
                    action: "%NAME%'s ear twitches with each gentle stroke from %OPP_NAME%",
                },
                {
                    sound: "",
                    action: "%NAME% makes soft noises of enjoyment as %OPP_NAME% rubs %POSSESSIVE% ear.",
            ...
            EarNibble: [
                {
                    sound: "",
                    action: "%NAME% closes %POSSESSIVE% eyes, relishing in the sensation of %OPP_NAME% nibbling %POSSESSIVE% ear.",
                },
                {
                    sound: "",
                    action: "%NAME%'s ear flickers as %OPP_NAME% tenderly nibbles on it.",
                },
                {
                    sound: "",
                    action: "%OPP_NAME%'s gentle nibbling causes %NAME% to give a contented sigh.",
                },
                {
                    sound: "",
                    action: "%NAME%'s ear quivers in pleasure as %OPP_NAME% gives it a soft nibble.",
                },
                {
                    sound: "",
                    action: "%OPP_NAME%'s nibbling on %NAME%'s ear elicits a low, satisfied rumble from the fox.",
                },
                {
                    sound: "",
                    action: "%NAME%'s ear twitches with excitement as %OPP_NAME% playfully nibbles on it.",
                },
            ],
            EarLick: [
                {
                    sound: "",
                    action: "%NAME% shivers with pleasure as %OPP_NAME% licks %POSSESSIVE% ear.",
                },
                {
                    sound: "",
                    action: "%NAME% wiggles %POSSESSIVE% ear, soaking up the attention from %OPP_NAME%'s lick.",
                },
                {
                    sound: "",
                    action: "%NAME% lets out a happy yip as %OPP_NAME% licks %POSSESSIVE% ear.",
                },
                {
                    sound: "",
                    action: "%NAME% relaxes, enjoying the sensation of %OPP_NAME% licking %POSSESSIVE% ear.",
                },
                {
                    sound: "",
                    action: "%OPP_NAME%'s lick sends shivers down %NAME%'s spine, causing %POSSESSIVE% ears to twitch.",
                },
                {
                    sound: "",
                    action: "%NAME%'s eyes close in contentment as %OPP_NAME% gently licks %POSSESSIVE% ears.",
                },
            ],
            EarKiss: [
                {
                    sound: "",
                    action: "%NAME% is enjoying the kiss on %POSSESSIVE% ear, %POSSESSIVE% ear twitching with pleasure.",
                },
                {
                    sound: "",
                    action: "%NAME% leans into the kiss, %POSSESSIVE% ear flicking with delight.",
                },
                {
                    sound: "",
                    action: "%NAME% closes %POSSESSIVE% eyes, relishing the feel of %OPP_NAME%'s kiss on %POSSESSIVE% ear.",
                },
                {
                    sound: "",
                    action: "A shiver runs down %NAME%'s back as %OPP_NAME%'s kiss reaches %POSSESSIVE% ear.",
                },
                {
                    sound: "",
                    action: "%NAME% tilts %POSSESSIVE% head, %POSSESSIVE% ear twitching in response to the soft kiss from %OPP_NAME%.",
                },
                {
                    sound: "",
                    action: "%NAME% nuzzles into %OPP_NAME%, %POSSESSIVE% ear quivering with contentment.",
                },
            ],
            HeadBrush: [
                {
                    sound: "",
                    action: "%NAME% relaxes into %OPP_NAME%'s touch, %POSSESSIVE% ears drooping contentedly.",
                },
                {
                    sound: "",
                    action: "%NAME% lets out a happy sigh as %OPP_NAME% brushes %POSSESSIVE% hair.",
                },
                {
                    sound: "",
                    action: "%NAME% closes %POSSESSIVE% eyes, thoroughly enjoying the brush from %OPP_NAME%.",
                ...
                {
                    sound: "",
                    action: "%NAME%'s ears flicker as %OPP_NAME% smooths down %POSSESSIVE% hair.",
                },
                {
                    sound: "",
                    action: "%NAME%'s hair ruffles in the breeze as %OPP_NAME% brushes it.",
                },
                {
                    sound: "",
                    action: "%NAME% nuzzles %OPP_NAME% affectionately as %POSSESSIVE% hair is brushed.",
                ...
                {
                    sound: "",
                    action: "%NAME% lets out a happy yip as %OPP_NAME% brushes %POSSESSIVE% hair.",
                },
            ],
            HeadPat: [
                {
                    sound: "",
                    action: "%NAME% lets out a happy little chirp at the attention from %OPP_NAME%.",
                },
                {
                    sound: "",
                    action: "%NAME%'s ears twitch as %OPP_NAME% gently rubs %POSSESSIVE% head.",
                },
                {
                    sound: "",
                    action: "%NAME% gives a soft sigh, enjoying %OPP_NAME%'s affectionate touch.",
                },
                {
                    sound: "",
                    action: "%NAME% leans into %OPP_NAME%'s hand, closing %POSSESSIVE% eyes contentedly.",
                },
                {
                    sound: "",
                    action: "%NAME%'s ears perk up happily at the touch from %OPP_NAME%.",
                },
                {
                    sound: "",
                    action: "%NAME%'s ears flop adorably as %OPP_NAME% pets %INTENSIVE%.",
            ...
            CaressBack: [
                {
                    sound: "",
                    action: `%NAME%'s tail twirls and %POSSESSIVE% eyes soften as %OPP_NAME% rubs %POSSESSIVE% back.`,
                },
                {
                    sound: "",
                    action: `%NAME% tilts %POSSESSIVE% head back and wags %POSSESSIVE% tail happily as %OPP_NAME% scratches %POSSESSIVE% back.`,
                },
                {
                    sound: "",
                    action: `%NAME%'s eyes close in bliss as %OPP_NAME% scratches %POSSESSIVE% spine.`,
                },
                {
                    sound: "",
                    action: `%NAME% let's out a content sigh as %OPP_NAME% gently rubs %POSSESSIVE% back.`,
                },
                {
                    sound: "",
                    action: `%NAME%'s tail wags eagerly as %OPP_NAME% runs some fingers along %POSSESSIVE% back.`,
                },
                {
                    sound: "",
                    action: `%NAME%'s tail twitches with joy as %OPP_NAME% pats %POSSESSIVE% back.`,
                },
            ],
            MassageBack: [
                {
                    sound: "",
                    action: "%NAME% lets out a happy sigh and %POSSESSIVE% tail flickers with joy as %OPP_NAME% massages %POSSESSIVE% back.",
                },
                {
                    sound: "",
                    action: "%NAME%'s tail wags happily as %OPP_NAME% massages %POSSESSIVE% back.",
                },
                {
                    sound: "",
                    action: "%NAME% closes %POSSESSIVE% eyes in bliss as %OPP_NAME% rubs %POSSESSIVE% back.",
                },
                {
                    sound: "",
                    action: "%NAME%'s tail twitches with pleasure as %OPP_NAME% massages %POSSESSIVE% back.",
                ...
                {
                    sound: "",
                    action: "%OPP_NAME%'s skilled hands have %NAME%'s tail wagging in pure joy",
                },
                {
                    sound: "",
                    action: "%NAME%'s tail twitches back and forth with delight as %OPP_NAME% massages %POSSESSIVE% back.",
            ...
            CaressButt: [
                ...
                {
                    sound: "",
                    action: "%NAME% leans into %OPP_NAME%'s touch, tail thumping with pleasure as %OPP_NAME% rubs %POSSESSIVE% butt.",
                },
                {
                    sound: "",
                    action: "%NAME% closes %POSSESSIVE% eyes and wags %POSSESSIVE% tail with delight as %OPP_NAME% caresses %POSSESSIVE% butt.",
                },
                {
                    sound: "",
                    action: "%NAME%'s tail wags eagerly as %OPP_NAME% runs some fingers along %POSSESSIVE% butt.",
                ...
                {
                    sound: "",
                    action: "%NAME%'s tail twitches in pleasure as %OPP_NAME% rubs %POSSESSIVE% butt.",
                },
                {
                    sound: "",
                    action: "%NAME% relaxes and leans into %OPP_NAME%'s touch, tail wagging with joy.",
                },
            ],
        },
        mouse: {
            EarCaress: [
                {
                    sound: "",
                    action: "%NAME% leans into %OPP_NAME%'s touch, savoring the caress of %POSSESSIVE% ear.",
                },
                {
                    sound: "",
                    action: "%NAME% closes %POSSESSIVE% eyes in bliss as %OPP_NAME% strokes %POSSESSIVE% ear.",
                },
                {
                    sound: "",
                    action: "%OPP_NAME%'s gentle touch sends shivers down %NAME%'s spine and wiggles %POSSESSIVE% ear.",
                },
                {
                    sound: "",
                    action: "%NAME% cuddles closer to %OPP_NAME%, basking in the attention to %POSSESSIVE% ear.",
                },
                {
                    sound: "",
                    action: "%NAME% twitches %POSSESSIVE% ear in delight as %OPP_NAME% rubs it tenderly.",
                },
                {
                    sound: "",
                    action: "%NAME% nuzzles into %OPP_NAME%'s hand, relishing the gentle touch on %POSSESSIVE% ear.",
            ...
            EarNibble: [
                {
                    sound: "",
                    action: "%OPP_NAME%'s gentle nibbling causes %NAME%'s ear to quiver with pleasure.",
                },
                {
                    sound: "",
                    action: "%NAME% lets out a contented sigh as %OPP_NAME% nibbles %POSSESSIVE% ear.",
                ...
                {
                    sound: "",
                    action: "%NAME% closes %POSSESSIVE% eyes and relishes in the sensation of %OPP_NAME% nibbling %POSSESSIVE% ear.",
                },
                {
                    sound: "",
                    action: "%NAME% shivers with pleasure as %OPP_NAME% tenderly nibbles %POSSESSIVE% ear.",
                },
                {
                    sound: "",
                    action: "%NAME%'s ear twitches with excitement as %OPP_NAME% playfully nibbles on it.",
            ...
            EarLick: [
                {
                    sound: "",
                    action: "%NAME%'s ears twitch with delight as %OPP_NAME% licks %POSSESSIVE% ear.",
                },
                {
                    sound: "",
                    action: "%NAME% lets out a contented sigh as %OPP_NAME% tenderly licks %POSSESSIVE% ear.",
                },
                {
                    sound: "",
                    action: "%NAME% shivers with pleasure as %OPP_NAME% delicately licks %POSSESSIVE% ear.",
                },
                {
                    sound: "",
                    action: "%NAME%'s ear perks up, eager for more affection as %OPP_NAME% licks it.",
                },
                {
                    sound: "",
                    action: "%OPP_NAME%'s lick sends shivers down %NAME%'s spine, causing %POSSESSIVE% ears to quiver.",
                },
                {
                    sound: "",
                    action: "%NAME% relaxes, enjoying the sensation of %OPP_NAME% licking %POSSESSIVE% ear.",
            ...
            EarKiss: [
                {
                    sound: "",
                    action: "%NAME%'s eyes close in bliss as %OPP_NAME% kisses %POSSESSIVE% ear.",
                },
                {
                    sound: "",
                    action: "%OPP_NAME%'s kiss sends shivers down %NAME%'s back, %POSSESSIVE% ears perking up.",
                },
                {
                    sound: "",
                    action: "%NAME% can't help but squeak as %OPP_NAME% plants a kiss on %POSSESSIVE% ear.",
                },
                {
                    sound: "",
                    action: "%NAME% leans into %OPP_NAME%'s affection, a contented grin on %POSSESSIVE% face.",
                ...
                {
                    sound: "",
                    action: "%NAME% lets out a contented sigh as %OPP_NAME% kisses %POSSESSIVE% ear.",
                },
            ],
            HeadBrush: [
                {
                ...
                {
                    sound: "",
                    action: "%NAME% relaxes into %OPP_NAME%'s touch, enjoying the brush.",
                },
                {
                    sound: "",
                    action: "%NAME% closes %POSSESSIVE% eyes, savoring the sensation of the brush.",
                },
                {
                    sound: "",
                    action: "%NAME%'s ears flop over in happiness as %OPP_NAME% attends to %POSSESSIVE% hair.",
                },
                {
                    sound: "",
                    action: "%NAME%'s eyes half-close in contentment as %OPP_NAME% brushes %POSSESSIVE% hair.",
                },
                {
                    sound: "",
                    action: "%NAME%'s ears twitch with delight at the sensation of the brush.",
                },
            ],
            HeadPat: [
                {
                    sound: "",
                    action: "%NAME% nuzzles into %OPP_NAME%'s hand, seeking more pets on %POSSESSIVE% head.",
                },
                {
                    sound: "",
                    action: "%NAME% relaxes completely, basking in the attention from %OPP_NAME%.",
                },
                {
                    sound: "",
                    action: "%NAME%'s ears perk up at the touch of %OPP_NAME%'s hand on %POSSESSIVE% head.",
                },
                {
                    sound: "",
                    action: "%NAME%'s ears twitch with delight as %OPP_NAME% pets %POSSESSIVE% head.",
                },
                {
                    sound: "",
                    action: "%NAME% gives a happy squeak as %OPP_NAME% pets %POSSESSIVE% head.",
                },
                {
                    sound: "",
                    action: "%OPP_NAME%'s gentle touch makes %NAME%'s eyes close in pleasure.",
                },
            ],
            CaressBack: [
                {
                    sound: "",
                    action: "%NAME% savors the feeling of %OPP_NAME%'s touch, %POSSESSIVE% tail lazily swishing back and forth.",
                },
                {
                    sound: "",
                    action: "%NAME% shivers with delight as %OPP_NAME% runs some fingers along %POSSESSIVE% back, %POSSESSIVE% tail wags excitedly.",
                },
                {
                    sound: "",
                    action: "%NAME% relaxes into %OPP_NAME%'s embrace, %POSSESSIVE% tail swaying softly.",
                },
                {
                    sound: "",
                    action: "%NAME%'s tail whips back and forth in delight as %OPP_NAME% strokes %POSSESSIVE% back.",
                },
                {
                    sound: "",
                    action: "%NAME% squeaks with happiness as %OPP_NAME% pets %POSSESSIVE% back, %POSSESSIVE% tail curling into a contented loop.",
                },
                {
                    sound: "",
                    action: "%NAME% leans into %OPP_NAME%'s touch, %POSSESSIVE% tail giving tiny little flickers of pleasure.",
                },
            ],
            MassageBack: [
                {
                ...
                {
                    sound: "",
                    action: "%OPP_NAME%'s fingers work magic on %NAME%'s back, eliciting happy squeaks.",
                },
                {
                    sound: "",
                    action: "%NAME% can barely contain %POSSESSIVE% excitement as %OPP_NAME% massages %POSSESSIVE% back.",
                },
                {
                    sound: "",
                    action: "%NAME%'s tail wags in delight as %OPP_NAME% gently massages %POSSESSIVE% back.",
                },
                {
                    sound: "",
                    action: "%OPP_NAME%'s touch sends shivers down %NAME%'s spine, causing %POSSESSIVE% tail to quiver with pleasure.",
                },
                {
                    sound: "",
                    action: "%OPP_NAME%'s massage has %NAME% squeaking with happiness, tail twirling with joy.",
                },
            ],
            CaressButt: [
                {
                    sound: "",
                    action: "%NAME%'s tail twitches with pleasure as %OPP_NAME% caresses %POSSESSIVE% butt.",
                },
                {
                    sound: "",
                    action: "%NAME%'s eyes close in bliss as %OPP_NAME% rubs %POSSESSIVE% butt.",
                },
                {
                    sound: "",
                    action: "%NAME% leans into %OPP_NAME%'s touch, tail thumping with happiness.",
                },
                {
                    sound: "",
                    action: "%NAME% closes %POSSESSIVE% eyes, letting out a contented squeak, as %OPP_NAME% caresses %POSSESSIVE% butt.",
                },
                {
                    sound: "",
                    action: "With a soft squeak, %NAME% leans into %OPP_NAME%'s touch, tail twitching and eyes half-closed in bliss.",
                },
                {
                    sound: "",
                    action: "%NAME% lets out a contented squeak, %POSSESSIVE% tail twirling around in delight.",
                },
            ],
        },
    };
    ...
    function replace_template(text, source_name = "") {
        ...
        result = result.replaceAll(
            "%CAP_POSSESSIVE%",
            Player.BCAR.bcarSettings.genderDefault.capPossessive,
        );
        result = result.replaceAll(
            "%PRONOUN%",
            Player.BCAR.bcarSettings.genderDefault.capPronoun.toLocaleLowerCase(),
        );
        result = result.replaceAll(
            "%CAP_PRONOUN%",
            Player.BCAR.bcarSettings.genderDefault.capPronoun,
        );
        result = result.replaceAll(
            "%INTENSIVE%",
            Player.BCAR.bcarSettings.genderDefault.capIntensive.toLocaleLowerCase(),
        );
        result = result.replaceAll(
            "%CAP_INTENSIVE%",
            Player.BCAR.bcarSettings.genderDefault.capIntensive,
        );
    ...
    function ActivityBeeper(type, source_name) {
        ...
        ServerSend("ChatRoomChat", {
            ...
            Dictionary: [
                {
                    Tag: "Beep",
                    Text: replace_template(actions[index].action, source_name),
                },
            ],
        });
        if (actions[index].sound.length)
            ServerSend("ChatRoomChat", {
                Type: "Chat",
                Content: actions[index].sound,
            });
    }
    ...
    function ArousalEarCaress() {
        if (Player.BCAR.bcarSettings.arousalEnable === true) {
            Player.ArousalSettings.ProgressTimer =
                Player.ArousalSettings.Progress + 2;
            ActivityChatRoomArousalSync(Player);
            Player.BCT.splitOrgasmArousal.ProgressTimer =
                Player.BCT.splitOrgasmArousal.arousalProgress + 15;
    ...
    function ArousalEarNibble() {
        if (Player.BCAR.bcarSettings.arousalEnable === true) {
            ...
            ActivityChatRoomArousalSync(Player);
            Player.BCT.splitOrgasmArousal.ProgressTimer =
                Player.BCT.splitOrgasmArousal.arousalProgress + 20;
            BCT_API?.ActivityChatRoomBCTArousalSync(Player);
        }
    }
    ...
    function ArousalEarLick() {
        if (Player.BCAR.bcarSettings.arousalEnable === true) {
            Player.ArousalSettings.ProgressTimer =
                Player.ArousalSettings.Progress + 7;
            ActivityChatRoomArousalSync(Player);
            Player.BCT.splitOrgasmArousal.ProgressTimer =
                Player.BCT.splitOrgasmArousal.arousalProgress + 20;
            BCT_API?.ActivityChatRoomBCTArousalSync(Player);
    ...
    function ArousalHeadBrush() {
        if (Player.BCAR.bcarSettings.arousalEnable === true) {
            Player.BCT.splitOrgasmArousal.ProgressTimer =
                Player.BCT.splitOrgasmArousal.arousalProgress + 2;
            BCT_API?.ActivityChatRoomBCTArousalSync(Player);
        }
    }
    ...
    function ArousalHeadPat() {
        if (Player.BCAR.bcarSettings.arousalEnable === true) {
            Player.ArousalSettings.ProgressTimer =
                Player.ArousalSettings.Progress + 1;
            ActivityChatRoomArousalSync(Player);
            Player.BCT.splitOrgasmArousal.ProgressTimer =
                Player.BCT.splitOrgasmArousal.arousalProgress + 2;
            BCT_API?.ActivityChatRoomBCTArousalSync(Player);
    ...
    function ArousalCaressButt() {
        if (Player.BCAR.bcarSettings.arousalEnable === true) {
            ...
            ActivityChatRoomArousalSync(Player);
            Player.BCT.splitOrgasmArousal.ProgressTimer =
                Player.BCT.splitOrgasmArousal.arousalProgress + 5;
            BCT_API?.ActivityChatRoomBCTArousalSync(Player);
        }
    }
    ...
    function Sleep() {
        if (
            InventoryGet(Player, "Emoticon")?.Property?.Expression !== "Sleep"
        ) {
            // check if Expression is not sleep
            //console.log("Sleep - Check")
            let numberBlinks = 1;
            let delay = 3000;
            for (let i = 0; i < numberBlinks; i++) {
                setTimeout(function () {
                    CharacterSetFacialExpression(Player, "Eyes", "Horny");
                }, i * delay);
                setTimeout(
                    function () {
    ...
    function EarWiggle() {
        if (Player.BCAR.bcarSettings.earWigglingEnable === true) {
            let earsVariations = [
                Player.BCAR.bcarSettings.earsDefault.ears2,
                Player.BCAR.bcarSettings.earsDefault.ears1,
            ];
            let earsColor = [
                Player.BCAR.bcarSettings.earsDefault.earsColor2,
                Player.BCAR.bcarSettings.earsDefault.earsColor1,
            ];
            let numberWiggles = parseInt(
                Player.BCAR.bcarSettings.earsDefault.earsCount,
            );
            let delay = parseInt(
                Player.BCAR.bcarSettings.earsDefault.earsDelay,
            );
            for (let i = 0; i < numberWiggles; i++) {
                setTimeout(function () {
                    InventoryWear(
                        Player,
                        earsVariations[i % earsVariations.length],
                        "HairAccessory2",
                        earsColor[i % earsColor.length],
                    );
    ...
    function TailWag() {
        if (Player.BCAR.bcarSettings.tailWaggingEnable === true) {
            let tailsVariations = [
                Player.BCAR.bcarSettings.tailsDefault.tails2,
                Player.BCAR.bcarSettings.tailsDefault.tails1,
            ];
            let tailsColor = [
                Player.BCAR.bcarSettings.tailsDefault.tailsColor2,
                Player.BCAR.bcarSettings.tailsDefault.tailsColor1,
            ];
            let numberWags = parseInt(
                Player.BCAR.bcarSettings.tailsDefault.tailsCount,
            );
            let delay = parseInt(
                Player.BCAR.bcarSettings.tailsDefault.tailsDelay,
            );
            for (let i = 0; i < numberWags; i++) {
                setTimeout(function () {
                    InventoryWear(
                        Player,
                        tailsVariations[i % tailsVariations.length],
                        "TailStraps",
                        tailsColor[i % tailsColor.length],
                    );
    ...
    function WingFlap() {
        if (Player.BCAR.bcarSettings.wingFlappingEnable === true) {
            let wingsVariations = [
                Player.BCAR.bcarSettings.wingsDefault.wings2,
                Player.BCAR.bcarSettings.wingsDefault.wings1,
            ];
            let wingsColor = [
                Player.BCAR.bcarSettings.wingsDefault.wingsColor2,
                Player.BCAR.bcarSettings.wingsDefault.wingsColor1,
            ];
            let numberFlaps = parseInt(
                Player.BCAR.bcarSettings.wingsDefault.wingsCount,
            );
            let delay = parseInt(
                Player.BCAR.bcarSettings.wingsDefault.wingsDelay,
            );
            for (let i = 0; i < numberFlaps; i++) {
                setTimeout(function () {
                    InventoryWear(
                        Player,
                        wingsVariations[i % wingsVariations.length],
                        "Wings",
                        wingsColor[i % wingsColor.length],
                    );
    ...
    function GetItemPreventingFly() {
        ...
        const otherPreventingItemNames = [
            "CeilingShackles",
            "FloorShackles",
            "SuspensionCuffs",
            "CeilingRope",
        ...
        return Player.Appearance.find(
            (i) =>
                [
                    ...
                    "IsLeashed",
                    "IsChained",
                ].some((e) => InventoryItemHasEffect(i, e)) ||
    ...
    function TryFly() {
        ...
        if (Player.BCAR.bcarSettings.wingFlappingEnable !== true) {
            ChatRoomSendLocal(
                "<p style='background-color:#000452;color:#EEEEEE;'><b>Bondage Club Auto React +</b>\n" +
                    "Wing flaping must be enabled to fly.</p>",
                wt.info,
            );
            return false;
        }
                ...
                Dictionary: [
                    {
                        ...
                        Text:
                            CharacterNickname(Player) +
                            " tried to fly while held down by a " +
                            preventingItem.Asset.Description +
                            ".",
                    },
                ],
                ...
                Dictionary: [
                    {
                        ...
                        Text: `${CharacterNickname(
                            Player,
                        )} was stopped from leaving by ${Player.BCAR.bcarSettings.genderDefault.capPossessive.toLocaleLowerCase()} own orgasm.`,
                    },
                ],
            });
        }
...
*/
    ...
    window.ChatRoomRegisterMessageHandler({
        Priority: -200,
        Description: "BCAR+ Emotes",
        Callback: (data, sender, msg, metadata) => {
            if (data.Type === "Emote" && data.Sender === Player.MemberNumber) {
                var sleepMessage = data.Content;
                let patterns = [/falls.*asleep/im, /sleeps/im]; // matches {<any> falls <any> asleep <any>}
                let result = patterns.find((pattern) =>
                    pattern.test(sleepMessage),
                );
                if (result) {
                    Sleep();
                }
            ...
            if (data.Type === "Emote" && data.Sender === Player.MemberNumber) {
                ...
                let patterns = [/wakes.*up/im]; // matches {<any> falls <any> asleep <any>}
                let result = patterns.find((pattern) =>
                    pattern.test(wakeMessage),
                );
                if (result) {
                    Wake();
                }
            ...
            if (
                ...
                Player.BCAR.bcarSettings.tailEmoteEnable
            ) {
                ...
                let patterns = [
                    ...
                    /tail.*wagging/im,
                    /wagging.*tail/im,
                ]; // matches {<any> wags <any> tail <any>}
                let result = patterns.find((pattern) =>
                    pattern.test(wagMessage),
                );
                if (result) {
                    if (
                        Player.BCT?.bctSettings?.tailWaggingEnable &&
                        Player.BCAR.bcarSettings.tailEmoteEnable
                    ) {
                        ChatRoomSendLocal(
            ...
            if (
                data.Type === "Emote" &&
                data.Sender === Player.MemberNumber &&
                Player.BCAR.bcarSettings.earEmoteEnable
            ) {
            ...
            if (data.Type === "Emote" && data.Sender === Player.MemberNumber) {
                ...
                let patterns = [/shows.*wings/im, /spreads.*wings/im]; // matches {<any> spreads <any> wings <any>}
                let result = patterns.find((pattern) =>
                    pattern.test(wingsSpreadMessage),
                );
                if (result) {
                    WingsSpread();
                }
            ...
            if (data.Type === "Emote" && data.Sender === Player.MemberNumber) {
                ...
                let patterns = [
                    /(flaps|flutters).*wings/im,
                    /wings.*(flapping|fluttering)/im,
                    /(flapping|fluttering).*wings/im,
                    /wings.*(flap|flutter)/im,
                ]; // matches {<any> flaps/flutter <any> wings <any>}
                let result = patterns.find((pattern) =>
                    pattern.test(flapMessage),
                );
                if (result) {
                    WingFlap();
                }
            ...
            if (data.Type === "Emote" && data.Sender === Player.MemberNumber) {
                ...
                let patterns = [/begins.*fly/im, /starts.*flying/im]; // matches {<any> begins <any> fly <any>}
                let result = patterns.find((pattern) =>
                    pattern.test(flyMessage),
                );
            ...
            if (data.Type === "Emote" && data.Sender === Player.MemberNumber) {
                ...
                let patterns = [
                    /(?<!Wheel of Fortune )lands/im,
                    /stops.*flying/im,
                ]; // matches {<any> stops <any> fly <any>}
                let result = patterns.find((pattern) =>
                    pattern.test(stopFlyMessage),
                );
                if (result) {
                    WingFlap();
                    Landing();
            ...
            if (data.Type === "Emote" && data.Sender === Player.MemberNumber) {
                ...
                let patterns = [
                    ...
                    /folds.*wings/im,
                    /retracts.*wings/im,
                ]; // matches {<any> flaps <any> wings <any>}
                let result = patterns.find((pattern) =>
    ...
    window.ChatRoomRegisterMessageHandler({
        ...
        Callback: (data, sender, msg, metadata) => {
            if (
                ...
                if (
                    data.Content.startsWith("Orgasm") ||
                    data.Content.startsWith("Orgasm") === -1
                ) {
                    if (
                        data.Content.indexOf("0") !== -1 ||
                        data.Content.indexOf("1") !== -1 ||
                        data.Content.indexOf("2") !== -1 ||
                        data.Content.indexOf("3") !== -1 ||
                        data.Content.indexOf("4") !== -1 ||
                        data.Content.indexOf("5") !== -1 ||
                        data.Content.indexOf("6") !== -1 ||
                        data.Content.indexOf("7") !== -1 ||
                        data.Content.indexOf("8") !== -1 ||
                        data.Content.indexOf("9") !== -1
                    ) {
    ...
    window.ChatRoomRegisterMessageHandler({
        Priority: 600,
        Description: "BCAR+ Auto Reactions",
        Callback: (data, sender, msg, metadata) => {
            ...
            if (
                Player.MemberNumber !==
                data.Dictionary.find((obj) => obj.Tag === "TargetCharacter")
                    ?.MemberNumber
            )
                return; // we aren't the target
            const source_number = data.Dictionary.find(
                (obj) => obj.Tag === "SourceCharacter",
            )?.MemberNumber;
            const source = window.ChatRoomCharacter.find(
                (c) => c.MemberNumber === source_number,
            );
    ...
    function bcarSettingsSave() {
        ...
        window.ServerAccountUpdate.QueueData({
            OnlineSettings: window.Player.OnlineSettings,
        });
    }
    ...
    async function bcarSettingsLoad() {
        ...
        const settings =
            migrateSettings() || Player.OnlineSettings.BCAR?.bcarSettings || {};
    ...
    const confirmationState = {
        ...
        reset() {
            ...
            if (this.timer) {
                // the timer is null at the beginning, but it may be set later by add() function. if it is set, we delete it and clear the variable
        ...
        add(part) {
            // confirmationState.add('ears') will set this.ears = true and set up a timer to reset and print a message -- Why does this print a message?
            this[part] = true;
        ...
        add_no_timer(part) {
            // confirmationState.add_no_timer('ears') will set this.ears = true
            this[part] = true;
        },
    };
    ...
    function CommandEarsChange(argsList) {
        ...
        switch (cmd) {
            case "ear1":
                ...
                Player.BCAR.bcarSettings.earsDefault.earsDescription1 =
                    ears?.Asset?.Description || "None";
                let updated_text = ``;
                if (!Player.BCAR.bcarSettings.earWigglingEnable) {
            ...
            case "ear2":
                ...
                s.earsDefault.earsDescription2 =
                    ears?.Asset?.Description || "None";
                ChatRoomSendLocal(
                    `<p style='background-color:#000452;color:#EEEEEE;'><b>Bondage Club Auto React +</b>
    ...
    function CommandTailChange(argsList) {
        ...
        switch (cmd) {
            case "tail1":
                ...
                s.tailsDefault.tailsDescription1 =
                    tails?.Asset?.Description || "None";
                let updated_text = ``;
    ...
    function CommandWingChange(argsList) {
        ...
        switch (cmd) {
            case "wing1":
                ...
                s.wingsDefault.wingsDescription1 =
                    wings?.Asset?.Description || "None";
                let updated_text = ``;
    ...
    function CommandProfile(argsList) {
        ...
        switch (cmd) {
            ...
            case "save3":
                ...
                profile.earWigglingEnable =
                    Player.BCAR.bcarSettings.earWigglingEnable;
                profile.earWigglingStatus =
                    Player.BCAR.bcarSettings.earWigglingStatus;

                profile.tailWaggingEnable =
                    Player.BCAR.bcarSettings.tailWaggingEnable;
                profile.tailWaggingStatus =
                    Player.BCAR.bcarSettings.tailWaggingStatus;

                profile.wingFlappingEnable =
                    Player.BCAR.bcarSettings.wingFlappingEnable;
                profile.wingFlappingStatus =
                    Player.BCAR.bcarSettings.wingFlappingStatus;

                for (const item of ["ears", "tails", "wings"]) {
                    profile[`${item}Default`] =
                        Player.BCAR.bcarSettings[`${item}Default`];
                }
            ...
            case "load3":
                ...
                for (const item of ["ears", "tails", "wings"]) {
                    Player.BCAR.bcarSettings[`${item}Default`] = copy_object(
                        profile[`${item}Default`],
                    );
                } // the loop ends here
                if (Player?.BCAR?.bcarSettings?.earsDefault?.ears1) {
                    InventoryWear(
                        ...
                        profile?.earsDefault?.ears1,
                        "HairAccessory2",
                        profile?.earsDefault?.earsColor1,
                    );
                } else {
                ...
                if (Player?.BCAR?.bcarSettings?.tailsDefault?.tails1) {
                    InventoryWear(
                        ...
                        profile?.tailsDefault?.tails1,
                        "TailStraps",
                        profile?.tailsDefault?.tailsColor1,
                    );
                } else {
                ...
                if (Player?.BCAR?.bcarSettings?.wingsDefault?.wings1) {
                    InventoryWear(
                        ...
                        profile?.wingsDefault?.wings1,
                        "Wings",
                        profile?.wingsDefault?.wingsColor1,
                    );
                } else {
                    InventoryRemove(Player, "Wings");
                }
    ...
    function CommandGenderToggle(argsList) {
        ...
        if (toggle === "male") {
            ...
            ChatRoomSendLocal(
                `<p style='background-color:#000452;color:#EEEEEE;'><b>Bondage Club Auto React +</b>
                <br>The reactions refer to ${CharacterNickname(
                    Player,
                )} as "he" now!
                </p>`.replaceAll("\n", ""),
                wt.info,
    ...
    function CommandOpenHelp(argsList) {
        ...
        switch (cmd) {
            ...
            case "":
                ...
                <br>/bcar male - Lets the reactions refer to ${CharacterNickname(
                    Player,
                )} as "he".
                <br>/bcar female - Lets the reactions refer to ${CharacterNickname(
                    Player,
                )} as "she".
                <br>/bcar other - Lets the reactions refer to ${CharacterNickname(
                    Player,
                )} as "they".
            ...
            case "status":
                ChatRoomSendLocal(
                    `<p style='background-color:#000452;color:#EEEEEE;'><b>Bondage Club Auto React +</b>
                               ...
                               <br>Primary Ears: ${
                                   s?.earsDefault?.earsDescription1
                               }
                               <br>Secondary Ears: ${
                                   s?.earsDefault?.earsDescription2
                               }
                               ...
                               <br>Secondary Tail: ${
                                   AssetGet(
                                       "Female3DCG",
                                       "TailStraps",
                                       s?.tailsDefault?.tails2,
                                   )?.Description || "None"
                               }
                               <br>Tail Wags: ${s?.tailsDefault?.tailsCount}
                               <br>Tail Wag Delay: ${
                                   s?.tailsDefault?.tailsDelay
                               }
    ...
    CommandCombine([
        {
            Tag: "bcar",
            Description:
                "<b>or /bcar help</b>: To open the commands overview and info.",
            AutoComplete: (words) => {
                if (words.length < 1) {
                ...
                if (words.length > 1) {
                    /*No output, because user has entered multiple words, and we can only complete the last one*/
                }
                if (words.length === 1) {
                    const matches = [];
                    ...
                    if (CurrentCharacter !== Player) {
                        ServerSend("ChatRoomChat", {
                            Content:
                                ...
                                " on you via console. If this is undesired, blacklist player.",
                            Type: "Whisper",
                            Target: CurrentCharacter.MemberNumber,
                        });
                    }
                    CurrentCharacter.Appearance =
                        CurrentCharacter.Appearance.filter((x) =>
                            CurrentCharacter.FocusGroup &&
                            CurrentCharacter.FocusGroup.Name
                                ? x.Asset.Group.Name !=
                                  CurrentCharacter.FocusGroup.Name
                                : true,
    ...
    function LoadPreferencesSubscreen(screenName) {
        ...
        if (
            typeof window[
                "PreferenceSubscreen" + PreferenceSubscreen + "Load"
            ] === "function"
        )
            CommonDynamicFunction(
                "PreferenceSubscreen" + PreferenceSubscreen + "Load()",
            );
    }
    ...
    w.PreferenceSubscreenBCARSettingsRun = function () {
        ...
        DrawText("- BCAR+ Settings -", 500, 125, "Black", "Gray");
        ...
        DrawTextFit("Open Changelog", 1635, 810, 380, "Black");
        DrawButton(
            1540,
            870,
            400,
        ...
        DrawTextFit("Open Wiki", 1650, 910, 308, "Black");
        DrawButton(500, getYPos(0), 400, 85, "", "White");
        DrawTextFit("List of all commands", 510, getYPos(0) + 42, 380, "Black");
        DrawButton(
            500,
            getYPos(1),
            400,
            85,
            "",
            "White" /*, "Assets/Female3DCG/HairAccessory1/Preview/KittenEars1.png"*/,
        );
        DrawTextFit("Ears", 510, getYPos(1) + 42, 380, "Black");
        DrawButton(500, getYPos(2), 400, 85, "", "White");
        DrawTextFit("Tails", 510, getYPos(2) + 42, 380, "Black");
        DrawButton(500, getYPos(3), 400, 85, "", "White");
        DrawTextFit("Wings", 510, getYPos(3) + 42, 380, "Black");
        DrawButton(500, getYPos(4), 400, 85, "", "White");
        DrawTextFit("Miscellaneous", 510, getYPos(4) + 42, 380, "Black");
        DrawButton(500, getYPos(5), 400, 85, "", "White");
        DrawTextFit("Profiles", 510, getYPos(5) + 42, 380, "Black");
    ...
    w.PreferenceSubscreenBCARSettingsClick = function () {
        if (MouseIn(1815, 75, 90, 90)) PreferenceSubscreenBCARSettingsExit();
        if (MouseIn(1540, 770, 400, 85))
            window.open(
                "https://github.com/DrBranestawm/BCAR/blob/main/script/changelog.md",
                "_blank",
            );
        if (MouseIn(1540, 870, 400, 85))
            window.open("https://github.com/DrBranestawm/BCAR/wiki", "_blank");

        if (MouseIn(500, getYPos(0), 400, 85))
            LoadPreferencesSubscreen("Commands");
        ...
        if (MouseIn(500, getYPos(3), 400, 85))
            LoadPreferencesSubscreen("Wings");
        if (MouseIn(500, getYPos(4), 400, 85)) LoadPreferencesSubscreen("Misc");
        if (MouseIn(500, getYPos(5), 400, 85))
            LoadPreferencesSubscreen("Profiles");
    ...
    function baseExit() {
        PreferenceSubscreen = "BCARSettings";
        PreferenceSettings = "BCAR+ Settings";
        bcarSettingsSave();
    } // Call at the end as it will save settings..
    function baseClick() {
        if (MouseIn(1815, 75, 90, 90)) {
            if (
                typeof window[
                    "PreferenceSubscreen" + PreferenceSubscreen + "Exit"
                ] === "function"
            )
                CommonDynamicFunction(
                    "PreferenceSubscreen" + PreferenceSubscreen + "Exit()",
    ...
    const command_pages = {
        pages: [
            ...
            },
            {
                ...
                lines: ["/bcar timer - Toggles the timer on/off."],
            },
            {
                // 10
                title: "Wing Commands",
        ...
        counter: function () {
            // Actually, let's count from 1 here
    ...
    function is_even(number) {
        if (number % 2 === 0) {
            // if integral division by 2 leaves 0 in the remainder
            return true;
        }
        return false;
    }
    ...
    w.PreferenceSubscreenBCARCommandsRun = function () {
        ...
        DrawText(command_pages.counter(), 1725, 230, "Black", "Gray");
    ...
    w.PreferenceSubscreenBCARCommandsClick = function () {
        ...
        if (MouseIn(1815, 180, 90, 90)) command_pages.next();
    ...
    function InputsReveal() {
        ...
        for (const id of Object.keys(InputStates.inputs)) {
            const element = document.getElementById(id);
            if (element && InputStates.inputs[id])
                element.style.display = InputStates.inputs[id];
        }
    ...
    w.PreferenceSubscreenBCAREarsLoad = function () {
        ...
        let callback = null;
        ElementCreateInput(
            "bcar_ears_wiggleCount",
            "number",
            "" + (Player.BCAR.bcarSettings.earsDefault.earsCount ?? 5),
            "2",
        );
        ...
        element.is_valid = true;
        ElementCreateInput(
            "bcar_ears_wiggleSpeed",
            "number",
            "" + (Player.BCAR.bcarSettings.earsDefault.earsDelay ?? 200),
            "4",
        );
        callback = function (event) {
            const element = event.target;
...
*/
        ...
        if (MouseIn(500 + 350, getYPos(6) - 32, 200, 64)) {
            if (
                document.getElementById("bcar_ears_wiggleCount").is_valid &&
                document.getElementById("bcar_ears_wiggleSpeed").is_valid
            ) {
                EarWiggle();
                PreferenceMessage = "";
            } else {
        ...
        if (MouseIn(1815, 750, 90, 90)) {
            ...
            DialogChangeClothes();
            Player.FocusGroup = AssetGroup.find(
                (g) => g.Name === "HairAccessory2",
            );
            DialogInventoryBuild(Player, true, false);
            AppearancePreviewBuild(Player, true);
            CharacterAppearanceCloth = InventoryGet(
                Player,
    ...
    w.PreferenceSubscreenBCARTailLoad = function () {
        ...
        ElementCreateInput(
            "bcar_tail_wagCount",
            "number",
            "" + (Player.BCAR.bcarSettings.tailsDefault.tailsCount ?? 5),
            "2",
        );
        callback = function (event) {
            const element = event.target;
        ...
        ElementCreateInput(
            "bcar_tail_wagSpeed",
            "number",
            "" + (Player.BCAR.bcarSettings.tailsDefault.tailsDelay ?? 200),
            "4",
        );
        callback = function (event) {
            const element = event.target;
    ...
    w.PreferenceSubscreenBCARTailClick = function () {
        ...
        if (MouseIn(500 + 350, getYPos(6) - 32, 200, 64)) {
            if (
                document.getElementById("bcar_tail_wagCount").is_valid &&
                document.getElementById("bcar_tail_wagSpeed").is_valid
            ) {
                TailWag();
                PreferenceMessage = "";
            } else {
    ...
    w.PreferenceSubscreenBCARWingsLoad = function () {
        ...
        ElementCreateInput(
            "bcar_wing_flapCount",
            "number",
            "" + (Player.BCAR.bcarSettings.wingsDefault.wingsCount ?? 5),
            "2",
        );
        callback = function (event) {
            const element = event.target;
        ...
        ElementCreateInput(
            "bcar_wing_flapSpeed",
            "number",
            "" + (Player.BCAR.bcarSettings.wingsDefault.wingsDelay ?? 200),
            "4",
        );
        callback = function (event) {
            const element = event.target;
    ...
    w.PreferenceSubscreenBCARWingsClick = function () {
        ...
        if (MouseIn(500 + 350, getYPos(6) - 32, 200, 64)) {
            if (
                document.getElementById("bcar_wing_flapCount").is_valid &&
                document.getElementById("bcar_wing_flapSpeed").is_valid
            ) {
                WingFlap();
                PreferenceMessage = "";
            } else {
    ...
    // MISCELLANEOUS MENU
    w.PreferenceSubscreenBCARMiscLoad = function () {
        baseLoad();
    };
    ...
    w.PreferenceSubscreenBCARMiscRun = function () {
        ...
        DrawCheckbox(
            ...
            64,
            "",
            Player.BCAR.bcarSettings.animationButtonsEnable,
        );
        ...
        DrawCheckbox(
            ...
            64,
            "",
            Player.BCAR.bcarSettings.arousalEnable,
        );
        ...
        DrawCheckbox(
            ...
            64,
            "",
            Player.BCAR.bcarSettings.expressionsEnable,
        );
    ...
    // PROFILES MENU
    w.PreferenceSubscreenBCARProfilesLoad = function () {
        baseLoad();
    };
    ...
    w.PreferenceSubscreenBCARProfilesClick = function () {
        ...
        if (MouseIn(500 + 250, getYPos(0) - 32, 200, 64)) {
            ...
            Player.BCAR.bcarSettings.profile1.earWigglingEnable =
                Player.BCAR.bcarSettings.earWigglingEnable;
            Player.BCAR.bcarSettings.profile1.earWigglingStatus =
                Player.BCAR.bcarSettings.earWigglingStatus;
            Player.BCAR.bcarSettings.profile1.earsDefault =
                Player.BCAR.bcarSettings.earsDefault;

            Player.BCAR.bcarSettings.profile1.tailWaggingEnable =
                Player.BCAR.bcarSettings.tailWaggingEnable;
            Player.BCAR.bcarSettings.profile1.tailWaggingStatus =
                Player.BCAR.bcarSettings.tailWaggingStatus;
            Player.BCAR.bcarSettings.profile1.tailsDefault =
                Player.BCAR.bcarSettings.tailsDefault;

            Player.BCAR.bcarSettings.profile1.wingFlappingEnable =
                Player.BCAR.bcarSettings.wingFlappingEnable;
            Player.BCAR.bcarSettings.profile1.wingFlappingStatus =
                Player.BCAR.bcarSettings.wingFlappingStatus;
        ...
        if (MouseIn(500 + 250, getYPos(1) - 32, 200, 64)) {
            ...
            Player.BCAR.bcarSettings.profile2.earWigglingEnable =
                Player.BCAR.bcarSettings.earWigglingEnable;
            Player.BCAR.bcarSettings.profile2.earWigglingStatus =
                Player.BCAR.bcarSettings.earWigglingStatus;
            Player.BCAR.bcarSettings.profile2.earsDefault =
                Player.BCAR.bcarSettings.earsDefault;

            Player.BCAR.bcarSettings.profile2.tailWaggingEnable =
                Player.BCAR.bcarSettings.tailWaggingEnable;
            Player.BCAR.bcarSettings.profile2.tailWaggingStatus =
                Player.BCAR.bcarSettings.tailWaggingStatus;
            Player.BCAR.bcarSettings.profile2.tailsDefault =
                Player.BCAR.bcarSettings.tailsDefault;

            Player.BCAR.bcarSettings.profile2.wingFlappingEnable =
                Player.BCAR.bcarSettings.wingFlappingEnable;
            Player.BCAR.bcarSettings.profile2.wingFlappingStatus =
                Player.BCAR.bcarSettings.wingFlappingStatus;
        ...
        if (MouseIn(500 + 250, getYPos(2) - 32, 200, 64)) {
            ...
            Player.BCAR.bcarSettings.profile3.earWigglingEnable =
                Player.BCAR.bcarSettings.earWigglingEnable;
            Player.BCAR.bcarSettings.profile3.earWigglingStatus =
                Player.BCAR.bcarSettings.earWigglingStatus;
            Player.BCAR.bcarSettings.profile3.earsDefault =
                Player.BCAR.bcarSettings.earsDefault;

            Player.BCAR.bcarSettings.profile3.tailWaggingEnable =
                Player.BCAR.bcarSettings.tailWaggingEnable;
            Player.BCAR.bcarSettings.profile3.tailWaggingStatus =
                Player.BCAR.bcarSettings.tailWaggingStatus;
            Player.BCAR.bcarSettings.profile3.tailsDefault =
                Player.BCAR.bcarSettings.tailsDefault;

            Player.BCAR.bcarSettings.profile3.wingFlappingEnable =
                Player.BCAR.bcarSettings.wingFlappingEnable;
            Player.BCAR.bcarSettings.profile3.wingFlappingStatus =
                Player.BCAR.bcarSettings.wingFlappingStatus;
    ...
    w.PreferenceSubscreenBCARConfirmAbortLoad = function () {
        baseLoad();
    };
    ...
    w.PreferenceSubscreenBCARConfirmAbortExit = function () {
        baseExit();
    };
        ...
        if (args[0] == "ChatRoomChat" && args[1]?.Type == "Activity") {
            ...
            if (actName.indexOf("BCAR_") == 0) {
                ...
                data.Dictionary.push({
                    Tag:
                        "MISSING ACTIVITY DESCRIPTION FOR KEYWORD " +
                        data.Content,
                    Text: msg,
                });
    ...
    CustomPrerequisiteFuncs.set(
        "HasTail",
        (acting, acted, group) => !!InventoryGet(acted, "TailStraps"),
    );
    CustomImages.set(wagActivity.Name, ICONS.TAIL);

    ActivityDictionary?.push(["ActivityBCAR_TailWag", "Wag Tail"]);
    ActivityDictionary?.push([
        "Label-ChatOther-ItemButt-BCAR_TailWag",
        "Wag Tail",
    ]);
    ActivityDictionary?.push([
        "ChatOther-ItemButt-BCAR_TailWag",
        "SourceCharacter wags PronounPossessive tail.",
    ]);
    ActivityDictionary?.push([
        "Label-ChatSelf-ItemButt-BCAR_TailWag",
        "Wag Tail",
    ]);
    ActivityDictionary?.push([
        "ChatSelf-ItemButt-BCAR_TailWag",
        "SourceCharacter wags PronounPossessive tail.",
    ]);
    ...
    function bcarExpressions() {
        if (Player.BCAR.bcarSettings.expressionsEnable) {
            // load the expressions and triggers
            ...
            for (let name of Object.keys(BCAR_Expression_Additions)) {
                ...
                if (w.bce_EventExpressions[name]) {
                    expressions_state.conflicts[name] =
                        w.bce_EventExpressions[name];
                }
            }
            ...
            // unload the expressions and triggers
            if (!expressions_state.loaded) return; // don't do anything if not loaded
            w.bce_ActivityTriggers = w.bce_ActivityTriggers.filter(
                (at) => at.Mod !== "BCAR+",
            ); // delete BCAR+ additions from triggers
            for (let name of Object.keys(w.bce_EventExpressions)) {
                // delete BCAR+ additions from expressions
                if (BCAR_Expression_Additions[name])
                    delete w.bce_EventExpressions[name];
            }
            Object.assign(w.bce_EventExpressions, expressions_state.conflicts); // load back saved conflicts
            for (let name of Object.keys(expressions_state.conflicts)) {
